  ...
  <div className="container mx-auto py-8">
    <div className="grid grid-cols-1 md:grid-cols-6 gap-8">
      ...
      <div className="footer-col">
       ...
       {/* Column 5 */}
       <div className="footer-col">
        <h4 className="font-bold mb-2 text-slate-400 text-md">Post To Us!</h4>
        <ul>
          <li><p href="#" className="text-sm text-zinc-300"> JCRS SANIL Enterprise, Town Badlapur, Post Badlapur <br/> District Jaunpur Uttar Pradesh <br/> India, 222125 </p></li>
