    ...
    <div className=' border-4 border-dotted border-rose-600 m-5 ' style={{ height: '600px' }}>
         <div className='flex justify-center'>
           <div className=' bg-indigo-500 rounded-md ml-2 mt-2 z-10'>
             <button className=" ml-0 mt-2 elative bg-rosy hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2  z-20" onClick={handleClick}>
               Youtube Downloader
             </button>
           </div>  
           <div className=' bg-indigo-500 rounded-md ml-2 mt-2'>
             <button className=" ml-0 mt-2 elative bg-rosy hover:shadow-lg transition duration-300 ease-in-out transform hover:scale-105 text-white font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-offset-2 z-20">
               Twitter Downloader
             </button>
           </div> 
           <div className=' bg-indigo-500 rounded-md ml-2 mt-2'>
