...
const Countries = () => {
    ...
    useEffect(() => {
        // Query Firestore for posts with category Countries'
        const postsRef = collection(db, 'Blogs_Contents');
        const q = query(postsRef, where('CategoryOfPost', '==', 'Countries'));
    ...
    return (
        <>
            <HelmetProvider>
                <title>environmental News - Workhelper</title>
                <link rel="canonical" href="https://www.workhelper.shop/Home/Countries" />
            </HelmetProvider>
            <NaviHome />
