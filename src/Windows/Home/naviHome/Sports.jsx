...
const Sports = () => {
    ...
    useEffect(() => {
        // Query Firestore for posts with category 'Sports'
        const postsRef = collection(db, 'Blogs_Contents');
        const q = query(postsRef, where('CategoryOfPost', '==', 'Sports'));
    ...
    return (
        <>
            <HelmetProvider>
                <title>Sports News - Workhelper</title>
                <meta name="description" content="Latest updates and insights from the world of sports." />
                <link rel="canonical" href="https://www.workhelper.shop/Sports" />
            </HelmetProvider>
            <NaviHome />
